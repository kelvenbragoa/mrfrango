...
const createRecordFunction = (values, actions) => {
    ...
    axios.post('/payments',values).then((response)=>{

    // categories.value.unshift(response.data);
    // $('#createCategory').modal('hide');
    actions.resetForm();
    router.push({ path: '/manager/payments' });
    toastr.success('Pagamento criada com sucesso');
  }).catch((error)=>{
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Formulário criação das Pagamentos do sistema.</h5>
