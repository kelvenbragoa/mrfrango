...
axios.delete(`/fees/${dataIdBeingDeleted}`)
.then(()=>{
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody v-if="retriviedData.data.length > 0">
                                                    <tr  v-for="(actualData,index) in retriviedData.data" :key="actualData.id">
                                                        ...
                                                        <td>
                                                            <span v-if="actualData.is_active == 0" class="badge bg-danger">
                                                                Inativo
                                                            </span>
                                                            <span v-if="actualData.is_active == 1" class="badge bg-success">
                                                                Ativo
                                                            </span>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <router-link :to="'/admin/fees/'+actualData.id+'/edit'"><vue-feather type="edit-2"></vue-feather></router-link>
                                                            <router-link :to="'/admin/fees/'+actualData.id"><vue-feather type="eye"></vue-feather></router-link> 
